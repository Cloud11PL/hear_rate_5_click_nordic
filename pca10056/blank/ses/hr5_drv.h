...
#define HR5_REG0H 0x00  //Control0
#define HR5_REG1H 0x01  //LED2STC
#define HR5_REG2H 0x02  //LED2ENDC
#define HR5_REG3H 0x03  //LED1LEDSTC
#define HR5_REG4H 0x04  //LED1LEDENDC
#define HR5_REG5H 0x05  //ALED2STC\LED3STC
#define HR5_REG6H 0x06  //ALED2ENDC\LED3ENDC
#define HR5_REG7H 0x07  //LED1STC
#define HR5_REG8H 0x08  //LED1ENDC
#define HR5_REG9H 0x09  //LED2LEDSTC
#define HR5_REGAH 0x0A  //LED2LEDENDC
#define HR5_REGBH 0x0B  //ALED1STC
#define HR5_REGCH 0x0C  //ALED1ENDC
#define HR5_REGDH 0x0D  //LED2CONVST
#define HR5_REGEH 0x0E  //LED2CONVEND
#define HR5_REGFH 0x0F  //ALED2CONVST\LED3CONVST
#define HR5_REG10H 0x10  //ALED2CONVEND\LED3CONVEND
#define HR5_REG11H 0x11  //LED1CONVST
#define HR5_REG12H 0x12  //LED1CONVEND
#define HR5_REG13H 0x13  //ALED1CONVST
#define HR5_REG14H 0x14  //ALED1CONVEND
#define HR5_REG15H 0x15  //ADCRSTSTCT0
#define HR5_REG16H 0x16  //ADCRSTENDCT0
#define HR5_REG17H 0x17  //ADCRSTSTCT1
#define HR5_REG18H 0x18  //ADCRSTENDCT1
#define HR5_REG19H 0x19  //ADCRSTSTCT2
#define HR5_REG1AH 0x1A  //ADCRSTENDCT2
#define HR5_REG1BH 0x1B  //ADCRSTSTCT3
#define HR5_REG1CH 0x1C  //ADCRSTENDCT3
#define HR5_REG1DH 0x1D  //PRPCT
#define HR5_REG1EH 0x1E  //timer controll
#define HR5_REG20H 0x20
#define HR5_REG21H 0x21
#define HR5_REG22H 0x22
#define HR5_REG23H 0x23
#define HR5_REG29H 0x29

#define HR5_REG2AH 0x2A  //LED2VAL
#define HR5_REG2BH 0x2B  //ALED2VAL\ALSED3VAL
#define HR5_REG2CH 0x2C  //LED1VAL
#define HR5_REG2DH 0x2D  //ALED1VAL
#define HR5_REG2EH 0x2E  //LED2-ALED2VAL
#define HR5_REG2FH 0x2F  //LED1-ALED1VAL

#define HR5_REG31H 0x31
#define HR5_REG32H 0x32
#define HR5_REG33H 0x33
#define HR5_REG34H 0x34
#define HR5_REG35H 0x35
#define HR5_REG36H 0x36
#define HR5_REG37H 0x37
#define HR5_REG39H 0x39
#define HR5_REG3AH 0x3A
#define HR5_REG3DH 0x3D
#define HR5_REG3FH 0x3F
#define HR5_REG40H 0x40

#define HR5_ADDR 0x58
 ...
 *
 */
uint8_t hr5_init(uint8_t address, dynamic_modes_t *dyn_modes);
 ...
 *
 */
uint8_t hr5_set_settings(sw_reset_t sw_reset, diag_mode_t diag_mode,
 ...
 *
 */
uint8_t hr5_set_led2_sample_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led1_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led3_sample_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led1_sample_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led2_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_amb1_sample_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led2_convert_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led3_convert_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led1_convert_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_amb1_convert_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_adc_reset0_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_adc_reset1_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_adc_reset2_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_adc_reset3_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_prpct_count(uint16_t count);
 ...
 *
 */
uint8_t hr5_set_seperate_tia_gain(bool seperate, uint8_t cf_setting, uint8_t gain_setting);
 ...
 * See hr5_replace_adc for just adc replacing.
 *
 *
 * @param seperate      -   Enable or Disable using seperate amplifier
 * @param cf_setting    -   CF setting for seperate TIA
 ...
 *
 */
uint8_t hr5_set_tia_gain(bool replace, uint8_t cf_setting, uint8_t gain_setting);
 ...
 *
 */
uint8_t hr5_replace_adc(bool replace);
 ...
 *
 */
uint8_t hr5_set_transmit_enable(transmitter_t transmit);
 ...
 *
 */
uint8_t hr5_set_current_range(led_current_range_t curr_range);
 ...
 *
 */
uint8_t hr5_set_adc_power(adc_pwer_t adc_power);
 ...
 *
 */
uint8_t hr5_set_clock_mode(clk_mode_t clk_mode);
 ...
 *
 */
uint8_t hr5_set_tia_power(tia_pwer_t tia_power);
 ...
 *
 */
uint8_t hr5_set_rest_of_adc(rest_of_adc_t rest_of_adc);
 ...
 *
 */
uint8_t hr5_set_afe_receive(afe_rx_mode_t afe_rx_mode);
 ...
 *
 */
uint8_t hr5_set_afe_mode(afe_mode_t afe_mode);
 ...
 *
 */
uint8_t hr5_set_clkout_enable(bool enable, uint8_t div);
 ...
 *
 */
uint32_t hr5_get_led1_val(void);
 ...
 *
 */
uint32_t hr5_get_led2_val(void);
 ...
 *
 */
uint32_t hr5_get_led3_val(void);
 ...
 *
 */
uint32_t hr5_get_amb1_val(void);
 ...
 *
 */
uint32_t hr5_get_led2_amb2_val(void);
 ...
 *
 */
uint32_t hr5_get_led1_amb1_val(void);
 ...
 *
 */
uint8_t hr5_is_pd_shorted(void);
 ...
 *
 */
uint8_t hr5_set_inp_inn_settings(inm_inn_t *inp_inn_setting);
 ...
 *
 */
uint8_t hr5_set_pdn_cycle_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_prgrmmbl_timing_start_end(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_led3_start_stop(uint16_t start, uint16_t end);
 ...
 *
 */
uint8_t hr5_set_offdac_settings(offdac_settings_t *settings);
